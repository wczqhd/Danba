...
let RECORD_CONST = require("record_status_Simple");
...
Component({
	...
	methods: {
		...
		handleRecordingCancel(){
			...
			recorderManager.onStop((res) => {
				...
				if (res.duration < 1000) {
			        ...
			        // 上传
              //  console.log("transSimplemsg  ", res.tempFilePath);
                this.transSimplemsg(res.tempFilePath, res.duration);
			    }
			});
			// 停止录音
       ...
       transSimplemsg(tempFilePath, dur) {
           var me = this;
           me.triggerEvent(
               "newAudioSimpleMsg",
               {
